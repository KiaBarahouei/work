...
/**
  ...
  *
  * Use the check(String line) method first. This will correct the cell that contains the declared
  * additives for a given product. Then use the readIngredients(String line) method which will read
  * the content od the ingredient cell and if it finds any additives it will add them to the result.
  * It will then ensure that the additive-grouping is done properly, and that there are no
  * duplicates.
  */

public class CheckAdditives{

  private String[] allCodes = {"1", "1.1", "2", "2.1", "2.2", "2.3", "3", "4", "5", "6", "7", "8", "9",
                              "9.1", "9.2", "10", "10.1", "10.2", "11", "12", "13", "14", "15",
                              "15.1", "15.2", "15.3"};



  private static String[][] additiveList = {{"Farbstoff", "1"},
    {"E102", "1.1"}, {"E110", "1.1"}, {"E122", "1.1"}, {"E124", "1.1"}, {"E129", "1.1"}, {"E414", "14"},
    {"E104", "1.1"}, {"Tartrazin", "1.1"}, {"Gelborange", "1.1"}, {"Azorubin", "1.1"}, {"Cochenillerot", "1.1"},
    ...
    {"Säureregulator", "13"}, {"Stabilisator", "14"}, {"Eiweiß", "15"}, {"Protein", "15"}, {"Stärke", "15.2"},
    {"E319", "3"}, {"E451", "13"}, {"E501", "13"}, {"E500", "13"}, {"E101", "1"}, {"E621", "4"}, {"E627", "4"},
    {"E631", "4"}
  };


  private static String[][] additiveGroups = {
    {"1", "1.1"},
    {"2", "2.1", "2.2", "2.3"},
    {"9", "9.1", "9.2"},
    {"10", "10.1", "10.2"},
  ...
  public String readIngredients(String line){
    ...
    backwardsRead : for(int n = length-1; n >= 0; n--){
      ...
      for(int i = 0; i < additiveList.length; i++){
        if(additiveList[i][0].length() <= runner.length()){
          if(runner.substring(0, additiveList[i][0].length()).equalsIgnoreCase(additiveList[i][0])){
